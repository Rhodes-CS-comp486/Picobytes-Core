...
class QuestionFetcher:
    ...
    def get_all_questions(self):
        ...
        conn = self._connect()
        cursor = conn.cursor()
        cursor.execute("SELECT id, question, option_a, option_b, option_c, option_d, correct_answer FROM multiple_choice")
    ...
    def get_question_by_id(self, question_id):
        ...
        conn = self._connect()
        cursor = conn.cursor()
        cursor.execute("SELECT id, question, option_a, option_b, option_c, option_d, correct_answer FROM multiple_choice WHERE id = ?", (question_id,))
    ...
    def get_random_question(self):
        ...
        conn = self._connect()
        cursor = conn.cursor()
        cursor.execute("SELECT id FROM multiple_choice")
